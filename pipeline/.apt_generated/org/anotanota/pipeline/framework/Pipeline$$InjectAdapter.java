...
public final class Pipeline$$InjectAdapter extends Binding<Pipeline>
  ...
  private Binding<java.util.List<Object>> modules;

  public Pipeline$$InjectAdapter() {
    super("org.anotanota.pipeline.framework.Pipeline", "members/org.anotanota.pipeline.framework.Pipeline", NOT_SINGLETON, Pipeline.class);
  }
  ...
  public void attach(Linker linker) {
    ...
    modules = (Binding<java.util.List<Object>>) linker.requestBinding("java.util.List<java.lang.Object>", Pipeline.class, getClass().getClassLoader());
  }
  ...
  @Override
  public Pipeline get() {
    Pipeline result = new Pipeline(service.get(), scope.get(), modules.get());
    return result;
  }
