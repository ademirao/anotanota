...
public final class ActivityModule$$ModuleAdapter extends ModuleAdapter<ActivityModule> {
  ...
  public static final class ContextProvidesAdapter extends ProvidesBinding<android.content.Context>
    ...
    public ContextProvidesAdapter(ActivityModule module) {
      super("android.content.Context", NOT_SINGLETON, "org.anotanota.framework.ActivityModule", "context");
      this.module = module;
      setLibrary(true);
    }
    ...
    public android.content.Context get() {
      return module.context(activity.get());
    }
  }
