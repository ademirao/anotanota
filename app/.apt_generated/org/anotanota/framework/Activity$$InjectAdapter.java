...
public final class Activity$$InjectAdapter extends Binding<Activity>
  ...
  public void attach(Linker linker) {
    mDrawerToggle = (Binding<android.support.v4.app.ActionBarDrawerToggle>) linker.requestBinding("@org.anotanota.framework.drawer.NavigationDrawer$Toggle()/android.support.v4.app.ActionBarDrawerToggle", Activity.class, getClass().getClassLoader());
    mMainViewController = (Binding<UIViewController>) linker.requestBinding("@org.anotanota.framework.App$MainViewController()/org.anotanota.framework.UIViewController", Activity.class, getClass().getClassLoader());
    mNavigation = (Binding<Navigation>) linker.requestBinding("org.anotanota.framework.Navigation", Activity.class, getClass().getClassLoader());
  }
