...
public class Gui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable.addKeyListener(new KeyListener() {
        	public boolean isPrintableChar( char c ) {
   			...
   			public void keyTyped(KeyEvent arg0) {
   				...
   				tableModel.setValueAt(Character.toString(c), selectedIndex, 0);
   				jTextFieldCharacter.setText(curBox.getChrs());
   				if (selectedIndex < (jTable.getRowCount() - 1)) {
   					jTable.getSelectionModel().setSelectionInterval(selectedIndex+1, selectedIndex+1);
   				}
   			}
                ...
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (selectedIndex != -1) {
                        ...
                        if (jTable.getSelectedRows().length == 1) {
                            ...
                            final TessBox curBox = boxesOfCurPage.get(selectedIndex);
                            final Rectangle rect = curBox.getRect();
                            try {
        ...
        this.addEditMenuItem(jMenuItemUp,
        		javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_UP, KeyEvent.ALT_MASK),
        		'U',"Box Up", new AbstractAction() {
        			@Override
        ...
        this.addEditMenuItem(jMenuItemDown,
        		javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_DOWN, KeyEvent.ALT_MASK),
        		'D',"Box down", new AbstractAction() {
        			@Override
        			public void actionPerformed(ActionEvent arg0) {
        				if (curBox == null) return;
        				final Rectangle rect = curBox.getRect();
        ...
        this.addEditMenuItem(jMenuItemLeft,
        		javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_LEFT, KeyEvent.ALT_MASK),
        		'L',"Box left", new AbstractAction() {
        	@Override
        	public void actionPerformed(ActionEvent arg0) {
        		if (curBox == null) return;
        		final Rectangle rect = curBox.getRect();
        ...
        this.addEditMenuItem(jMenuItemRight,
        		javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_RIGHT, KeyEvent.ALT_MASK),
        		'R',"Box Right", new AbstractAction() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				if (curBox == null) return;
				final Rectangle rect = curBox.getRect();
        ...
        this.addEditMenuItem(jMenuItemIncreaseHeight,
        		KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, KeyEvent.SHIFT_MASK | KeyEvent.ALT_MASK, false),
        		'H',"Box Increase Height", new AbstractAction() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				if (curBox == null) return;
				final Rectangle rect = curBox.getRect();
        ...
        this.addEditMenuItem(jMenuItemDecreaseHeight,
        		KeyStroke.getKeyStroke(KeyEvent.VK_UP, KeyEvent.SHIFT_MASK | KeyEvent.ALT_MASK, false),
        		'h',"Box Decrease Height",new AbstractAction() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				if (curBox == null) return;
				final Rectangle rect = curBox.getRect();
        ...
        this.addEditMenuItem(jMenuItemIncreaseWidth,
        		KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT, KeyEvent.SHIFT_MASK | KeyEvent.ALT_MASK, false),
        		'W',"Box Increase Width", new AbstractAction() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				if (curBox == null) return;
				final Rectangle rect = curBox.getRect();
        ...
        this.addEditMenuItem(jMenuItemDecreaseWidth,
        		KeyStroke.getKeyStroke(KeyEvent.VK_LEFT, KeyEvent.SHIFT_MASK | KeyEvent.ALT_MASK, false),
        		'w',"Box Decrease Width",new AbstractAction() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				if (curBox == null) return;
				final Rectangle rect = curBox.getRect();
	...
	public void addEditMenuItem(JMenuItem jMenuItem, KeyStroke keyStroke, char mnemonic, String text, Action action) {
...
//            oome.printStackTrace();
    ...
    private javax.swing.JMenuItem jMenuItemUp = new JMenuItem();

    private javax.swing.JMenuItem jMenuItemDown = new JMenuItem();

    private javax.swing.JMenuItem jMenuItemLeft = new JMenuItem();

    private javax.swing.JMenuItem jMenuItemRight = new JMenuItem();

    private javax.swing.JMenuItem jMenuItemIncreaseHeight = new JMenuItem();

    private javax.swing.JMenuItem jMenuItemDecreaseHeight = new JMenuItem();
    private javax.swing.JMenuItem jMenuItemIncreaseWidth = new JMenuItem();

    private javax.swing.JMenuItem jMenuItemDecreaseWidth = new JMenuItem();
    private JMenuItem jMenuItemEditLetter = new JMenuItem();
